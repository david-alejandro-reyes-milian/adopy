...
import com.example.androiddevchallenge.utils.LocalSysUiController

private val LightColorPalette = AdopyColors(
    brand = Shadow5,
...
private val DarkColorPalette = AdopyColors(
    brand = Shadow1,
...
object AdopyTheme {
    val colors: AdopyColors
        @Composable
        get() = LocalAdopyColors.current
}

/**
 * Adopy custom Color Palette
 */
...
@Composable
fun ProvideAdopyColors(
    colors: AdopyColors,
    content: @Composable () -> Unit
) {
    val colorPalette = remember { colors }
    colorPalette.update(colors)
    CompositionLocalProvider(LocalAdopyColors provides colorPalette, content = content)
}

private val LocalAdopyColors = staticCompositionLocalOf<AdopyColors> {
    error("No AdopyColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [AdopyTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
